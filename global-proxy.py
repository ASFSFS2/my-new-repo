#!/usr/bin/env python3
"""
Global proxy for Neo AI with proper CORS and routing
"""
...
class GlobalProxyHandler(BaseHTTPRequestHandler):
    def do_OPTIONS(self):
...
if __name__ == '__main__':
    server = HTTPServer(('0.0.0.0', 9000), GlobalProxyHandler)
    print("🚀 Starting Neo AI Global Proxy...")
    print("🌍 Port: 9000")
    print("📡 Frontend: http://localhost:3000")
    print("🔧 Backend: http://localhost:8000")
    print("✅ CORS enabled for global access")
