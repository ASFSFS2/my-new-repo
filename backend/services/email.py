...
class EmailService:
    def __init__(self):
        ...
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Neo Team')
    ...
    def send_welcome_email(self, user_email: str, user_name: Optional[str] = None) -> bool:
        ...
        subject = "🎉 Welcome to Neo — Let's Get Started "
...
<head>
  ...
  <title>Welcome to Kortix Neo</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-neo-logo.png" alt="Kortix Neo Logo" class="logo">
    </div>
    <h1>Welcome to Kortix Neo!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Kortix Neo — we're excited to have you on board!</strong></em></p>
    ...
    <p>To celebrate your arrival, here's a <strong>15% discount</strong> to try out the best version of Neo (1 month):</p>
    ...
    <p>Thanks again, and welcome to the Neo community <span class="emoji">🌞</span></p>

    <p>— The Neo Team</p>

    <a href="https://www.neo.so/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Neo — we're excited to have you on board!
...
To celebrate your arrival, here's a 15% discount to try out the best version of Neo (1 month):
...
Thanks again, and welcome to the Neo community 🌞

— The Neo Team

Go to the platform: https://www.neo.so/

---
© 2024 Neo. All rights reserved.
You received this email because you signed up for a Neo account."""
