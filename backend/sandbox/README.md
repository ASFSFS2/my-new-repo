...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `kortix/neo:___`)
...
3. Push the new version: `docker push kortix/neo:0.1.3`
