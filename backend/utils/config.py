...
class Configuration:
    ...
    OR_SITE_URL: Optional[str] = "https://neo.ai"
    OR_APP_NAME: Optional[str] = "NEO"    
    ...
    # Model configuration
    MODEL_TO_USE: Optional[str] = "deepseek/deepseek-chat:free"
    ...
    # Sandbox configuration
    SANDBOX_IMAGE_NAME = "python:3.11-slim"
