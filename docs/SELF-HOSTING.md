# Neo Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of Neo, an open-source generalist AI agent.
...
- Start Neo using your preferred method
...
Neo can be started in two ways:
...
For further assistance, join the [Neo Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/kortix-ai/neo) for updates and issues.
